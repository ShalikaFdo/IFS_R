...
ewAr[155] = ""+"\r\n"+""+"\r\n"+"	//"+"\r\n"+"	// Page main"+"\r\n"+"	//"+"\r\n"+"	function Page_Main() {"+"\r\n"+"		global $Security;"+"\r\n"+"		global $ReportLanguage;"+"\r\n"+""+"\r\n"+"";
ewAr[156] = ""+"\r\n"+"		$this->Page_Terminate(\"";
ewAr[157] = "\"); // Exit and go to default page"+"\r\n"+"";
ewAr[158] = ""+"\r\n"+"		$this->Page_Terminate(\"";
ewAr[159] = "\"); // Exit and go to default page"+"\r\n"+"";
ewAr[160] = ""+"\r\n"+"		if (!$Security->IsLoggedIn()) $Security->AutoLogin();"+"\r\n"+"			";
ewAr[161] = ""+"\r\n"+"		$Security->LoadUserLevel(); // Load User Level"+"\r\n"+"			";
ewAr[162] = ""+"\r\n"+"";
ewAr[163] = ""+"\r\n"+"		";
ewAr[164] = ""+"\r\n"+"			$this->Page_Terminate(\"";
ewAr[165] = "\"); // Exit and go to default page"+"\r\n"+"		";
ewAr[166] = ""+"\r\n"+"";
ewAr[167] = ""+"\r\n"+"		";
ewAr[168] = ""+"\r\n"+"			$this->Page_Terminate(\"";
ewAr[169] = "\");"+"\r\n"+"		";
...
ewAr[172] = "\\\">\" . $ReportLanguage->Phrase(\"BackToLogin\") . \"</a></p>\");"+"\r\n"+"		} else {"+"\r\n"+"			$this->Page_Terminate(\"";
ewAr[173] = "\"); // Exit and go to login page"+"\r\n"+"		}"+"\r\n"+"";
ewAr[174] = ""+"\r\n"+"	}"+"\r\n"+"";
ewAr[175] = ""+"\r\n"+"";
ewAr[176] = ""+"\r\n"+"	";
ewAr[177] = ""+"\r\n"+"	";
...
ewAr[202] = "->Page_Render();"+"\r\n"+"";
ewAr[203] = ""+"\r\n"+"?>"+"\r\n"+"";
ewAr[204] = ""+"\r\n"+"";
ewAr[205] = ""+"\r\n"+"";
ewAr[206] = ""+"\r\n"+"<?php $";
ewAr[207] = "->ShowMessage(); ?>"+"\r\n"+"";
ewAr[208] = ""+"\r\n"+"";
ewAr[209] = ""+"\r\n"+"";
ewAr[210] = ""+"\r\n"+"<?php"+"\r\n"+"$";
ewAr[211] = "->Page_Terminate();"+"\r\n"+"if (isset($OldPage)) $";
ewAr[212] = " = $OldPage;"+"\r\n"+"?>"+"\r\n"+"";
