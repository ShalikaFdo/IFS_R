...
ewAr[124] = "\\\" href=\\\"javascript:void(0);\\\" onclick=\\\"ewr_EmailDialogShow({lnk:'emf_";
ewAr[125] = "',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\\\">\" . ";
ewAr[126] = " . \"</a>\";"+"\r\n"+"		$item->Visible = ";
...
ewAr[131] = "\\\">\" . $ReportLanguage->Phrase(\"SearchBtn\") . \"</button>\";"+"\r\n"+"		$item->Visible = ";
...
ewAr[239] = ""+"\r\n"+"<?php $";
ewAr[240] = "->ShowPageHeader(); ?>"+"\r\n"+"";
ewAr[241] = ""+"\r\n"+"";
ewAr[242] = ""+"\r\n"+"<?php $";
ewAr[243] = "->ShowMessage(); ?>"+"\r\n"+"";
ewAr[244] = ""+"\r\n"+""+"\r\n"+"<form name=\"";
ewAr[245] = "\" id=\"";
ewAr[246] = "\" class=\"form-horizontal ewForm ewLoginForm\" action=\"<?php echo ewr_CurrentPage() ?>\" method=\"post\">"+"\r\n"+"<?php if ($Page->CheckToken) { ?>"+"\r\n"+"<input type=\"hidden\" name=\"<?php echo EWR_TOKEN_NAME ?>\" value=\"<?php echo $Page->Token ?>\">"+"\r\n"+"<?php } ?>"+"\r\n"+"";
ewAr[247] = ""+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<label class=\"";
ewAr[248] = "\" for=\"username\">";
ewAr[249] = "</label>"+"\r\n"+"		<div class=\"";
ewAr[250] = "\"><input type=\"text\" name=\"username\" id=\"username\" class=\"";
ewAr[251] = "\" value=\"<?php echo ewr_HtmlEncode($";
ewAr[252] = "->Username) ?>\"";
ewAr[253] = "></div>"+"\r\n"+"	</div>"+"\r\n"+"";
ewAr[254] = ""+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<label class=\"";
ewAr[255] = "\" for=\"password\">";
ewAr[256] = "</label>"+"\r\n"+"		<div class=\"";
ewAr[257] = "\"><input type=\"password\" name=\"password\" id=\"password\" class=\"";
ewAr[258] = "\"";
ewAr[259] = "></div>"+"\r\n"+"	</div>"+"\r\n"+"";
ewAr[260] = " "+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<div class=\"";
ewAr[261] = "\">"+"\r\n"+"			<a id=\"ewLoginOptions\" class=\"collapsed\" data-toggle=\"collapse\" data-target=\"#";
ewAr[262] = "_options\"><?php echo $ReportLanguage->Phrase(\"LoginOptions\") ?> <span class=\"icon-arrow\"></span></a>"+"\r\n"+"			<div id=\"";
ewAr[263] = "_options\" class=\"collapse\">"+"\r\n"+"		";
ewAr[264] = ""+"\r\n"+"					<div class=\"radio ewRadio\">"+"\r\n"+"					<label for=\"type1\"><input type=\"radio\" name=\"type\" id=\"type1\" value=\"a\"<?php if ($";
ewAr[265] = "->LoginType == \"a\") { ?> checked=\"checked\"<?php } ?>>";
ewAr[266] = "</label>"+"\r\n"+"					</div>"+"\r\n"+"		";
ewAr[267] = ""+"\r\n"+"		";
ewAr[268] = ""+"\r\n"+"					<div class=\"radio ewRadio\">"+"\r\n"+"					<label for=\"type2\"><input type=\"radio\" name=\"type\" id=\"type2\" value=\"u\"<?php if ($";
ewAr[269] = "->LoginType == \"u\") { ?>  checked=\"checked\"<?php } ?>>";
ewAr[270] = "</label>"+"\r\n"+"					</div>"+"\r\n"+"		";
ewAr[271] = ""+"\r\n"+"		";
ewAr[272] = ""+"\r\n"+"					<div class=\"radio ewRadio\">"+"\r\n"+"					<label for=\"type3\"><input type=\"radio\" name=\"type\" id=\"type3\" value=\"\"<?php if ($";
ewAr[273] = "->LoginType == \"\") { ?> checked=\"checked\"<?php } ?>>";
ewAr[274] = "</label>"+"\r\n"+"					</div>"+"\r\n"+"		";
ewAr[275] = ""+"\r\n"+"		</div>"+"\r\n"+"	</div>"+"\r\n"+"	</div>"+"\r\n"+"";
ewAr[276] = ""+"\r\n"+""+"\r\n"+"";
ewAr[277] = ""+"\r\n"+"";
ewAr[278] = ""+"\r\n"+""+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<div class=\"";
ewAr[279] = "\">"+"\r\n"+"			<button class=\"";
ewAr[280] = "\" name=\"btnsubmit\" id=\"btnsubmit\" type=\"submit\"><?php echo $ReportLanguage->Phrase(\"Login\") ?></button>"+"\r\n"+"		</div>"+"\r\n"+"	</div>"+"\r\n"+""+"\r\n"+"";
ewAr[281] = ""+"\r\n"+"	";
