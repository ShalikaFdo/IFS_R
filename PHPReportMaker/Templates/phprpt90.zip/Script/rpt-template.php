...
var EWR_SESSION_URL = EWR_RELATIVE_PATH + "<!--##=ew_GetFileNameByCtrlID("session")##-->"; // Session URL
...
var EWR_LOGOUT_URL = EWR_RELATIVE_PATH + "<!--##=sFnLogout##-->"; // Logout URL
...
<?php } ?>
<!--## } ##-->
<script type="text/javascript">if (window.jQuery && typeof MobileDetect === 'undefined') ewr_GetScript("<!--##=ew_FolderPath("_js")##-->/<!--##=ew_GetFileNameByCtrlID("mobile-detect.js", false)##-->");</script>
<script type="text/javascript">if (window.jQuery && typeof Moment === 'undefined') ewr_GetScript("<!--##=ew_FolderPath("_js")##-->/<!--##=ew_GetFileNameByCtrlID("moment.js", false)##-->");</script>
...
?>
<!--## } ##-->
<script type="text/javascript">ewr_GetScript("<!--##=ew_FolderPath("_js")##-->/<!--##=ew_GetFileNameByCtrlID("rptuserglobaljs", false)##-->");</script>
...
##-->
<!--##=sTmplExpStart##-->
<script type="text/javascript">ewr_GetScript("<!--##=ew_FolderPath("_js")##-->/<!--##=ew_GetFileNameByCtrlID("rptusereventjs", false)##-->");</script>
