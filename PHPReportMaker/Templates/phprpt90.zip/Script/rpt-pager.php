...
<select name="<?php echo EWR_TABLE_GROUP_PER_PAGE; ?>" class="form-control input-sm" onchange="this.form.submit();">
	...
	##-->
<option value="<!--##=thisDisplayGrps##-->"<?php if ($<!--##=gsPageObj##-->->DisplayGrps == <!--##=thisValue##-->) echo " selected" ?>><!--##=thisDisplayGrps##--></option>
	<!--##
			} else {
	##-->
<option value="ALL"<?php if ($<!--##=gsPageObj##-->->getGroupPerPage() == -1) echo " selected" ?>><!--##@AllRecords##--></option>
	<!--##
			}
		}
	##-->
