...
define("EWR_PROJECT_NAME", "<!--##=sProjVar##-->", TRUE); // Project Name
define("EWR_CONFIG_FILE_FOLDER", EWR_PROJECT_NAME . "<!--##=ew_FolderPath("_security")##-->", TRUE); // Config file folder
...
$EWR_CONN["DB"] = <!--##=SYSTEMFUNCTIONS.DatabaseConnection(DB)##-->;
...
<!--##
	for (var i = 1, len = PROJ.LINKDBS.Count(); i <= len; i++) {
		...
		var dbid = db.DBID;
##-->
$EWR_CONN["<!--##=dbid##-->"] = <!--##=SYSTEMFUNCTIONS.DatabaseConnection(db)##-->;
$EWR_CONN[<!--##=i##-->] = &$EWR_CONN["<!--##=dbid##-->"];
<!--##
	}
##-->
...
define("EWR_SESSION_TIMEOUT", <!--##=PROJ.GetV("SessTimeOut")##-->, TRUE); // Session timeout time (minutes)

// Session keep alive interval
define("EWR_SESSION_KEEP_ALIVE_INTERVAL", <!--##=PROJ.GetV("SessionKeepAliveInterval")##-->, TRUE); // Session keep alive interval (seconds)
define("EWR_SESSION_TIMEOUT_COUNTDOWN", <!--##=PROJ.GetV("SessionTimeoutCountdown")##-->, TRUE); // Session timeout count down interval (seconds)
...
define("EWR_ALLOW_LOGIN_BY_URL", <!--##=ew_Val(PROJ.GetV("AllowLoginByUrl"))##-->, TRUE); // Allow login by URL
define("EWR_ALLOW_LOGIN_BY_SESSION", <!--##=ew_Val(PROJ.GetV("AllowLoginBySession"))##-->, TRUE); // Allow login by session variables
...
##-->
define("EWR_USER_TABLE_DBID", "<!--##=ew_Quote(sUserTableDBID)##-->", TRUE);
define("EWR_USER_TABLE", "<!--##=ew_Quote2(sUserTable)##-->", TRUE);
define("EWR_USER_NAME_FILTER", "<!--##=ew_Quote2(sFilter)##-->", TRUE);
<!--##
...
@define("EWR_USER_LEVEL_DBID", "<!--##=ew_Quote(sUserLevelDBID)##-->", TRUE);
@define("EWR_USER_LEVEL_TABLE", "<!--##=ew_Quote2(sUserLevelTbl)##-->", TRUE);
@define("EWR_USER_LEVEL_ID_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelIdFld))##-->", TRUE);
@define("EWR_USER_LEVEL_NAME_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelNameFld))##-->", TRUE);
...
@define("EWR_USER_LEVEL_PRIV_DBID", "<!--##=ew_Quote(sUserLevelPrivDBID)##-->", TRUE);
@define("EWR_USER_LEVEL_PRIV_TABLE", "<!--##=ew_Quote2(sUserLevelPrivTbl)##-->", TRUE);
@define("EWR_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivTblNameFld))##-->", TRUE);
@define("EWR_USER_LEVEL_PRIV_TABLE_NAME_FIELD_2", "<!--##=ew_Quote2(DB.UserLevelPrivTblNameFld)##-->", TRUE);
@define("EWR_USER_LEVEL_PRIV_TABLE_NAME_FIELD_SIZE", 255, TRUE);
@define("EWR_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivUserLevelFld))##-->", TRUE);
@define("EWR_USER_LEVEL_PRIV_PRIV_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivPrivFld))##-->", TRUE);
<!--## } ##-->
...
##-->
define("EWR_EMAIL_LOG_TABLE_DBID", "<!--##=ew_Quote(sEmailTableDBID)##-->", TRUE); // Email log table dbid
...
define("EWR_UPLOAD_DEST_PATH", "<!--##=sUploadPath##-->", TRUE); // Upload destination path (relative to app root)
...
define("EWR_ENCRYPT_FILE_PATH", <!--##=ew_Val(PROJ.GetV("EncryptFilePath"))##-->, TRUE); // Encrypt file path
$EWR_THUMBNAIL_CLASS = "crThumbnail";
define("EWR_REDUCE_IMAGE_ONLY", <!--##=ew_Val(bReduceImageOnly)##-->, TRUE);
define("EWR_KEEP_ASPECT_RATIO", <!--##=ew_Val(bKeepAspectRatio)##-->, TRUE);
...
define("EWR_USE_CUSTOM_TEMPLATE", <!--##=ew_Val(PROJ.GetV("UseCustomTemplate"))##-->, TRUE);
