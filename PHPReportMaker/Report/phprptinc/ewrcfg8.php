...
define("EWR_PROJECT_ID", "{7F37EE0F-BC09-413F-9B82-414FB739A1E5}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "demo8", TRUE); // Project Name
define("EWR_PROJECT_VAR", "demo8", TRUE); // Project Var
...
define("EWR_CONN_DB", 'demorpt8', TRUE);
...
define("EWR_CODEPAGE", 28591, TRUE); // Code page
define("EWR_CHARSET", "iso-8859-1", TRUE); // Project charset
...
define("EWR_DEFAULT_DATE_FORMAT", "mm/dd/yyyy", TRUE); // Default date format
define("EWR_DATE_SEPARATOR", "/", TRUE); // Date separator
define("EWR_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EWR_RANDOM_KEY", '2Kq12Z83TX8j0Uke', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/demo8.css", TRUE); // Project stylesheet file name
 ...
 * details.
 */
define("EWR_ENCODING", "ISO-8859-1", TRUE); // Character encoding
 ...
 */
define("EWR_MYSQL_CHARSET", "latin1", TRUE);
...
define("EWR_SHOW_DRILLDOWN_FILTER", FALSE, TRUE); // True to show drill down filter
...
define("EWR_ADMIN_PASSWORD", "master", TRUE);
